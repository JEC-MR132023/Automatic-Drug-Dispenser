//This version of the code fetchs medicine date every 30 seconds to check any update in the database. It also alerts the user when the stock gets low
...
class _MedsListScreenState extends State<MedsListScreen> {
  ...
  void initState() {
    super.initState();
    fetchMeds(); // Fetch initial data when the screen is first displayed
    Timer.periodic(Duration(seconds: 30), (Timer timer) {
      fetchMeds(); // Fetch data every 30 seconds
    });
  }
